...
public class ConquistaComposite implements Conquista {
    private String nome;
    private String descricao;
    private List<Conquista> conquistas = new ArrayList<>();

    public ConquistaComposite(String nome, String descricao) {
        this.nome = nome;
    ...
    public boolean equals(Object o) {
        ...
        ConquistaComposite grupo = (ConquistaComposite) o;
